const ADMIN_ID = 'admin'
      ...
      function getRegionGroup(district) {
        ...
        // 부울경·대구권 주요 지명은 하나로 묶어 "부산권" 처리
        // 모호한 키워드(남구·북구·강서구 등)는 제외하고, 도시/광역시 접두나 고유 구·군 이름만 사용
        const BUSAN_BELT_KEYWORDS = [
          '부산광역시',
          '부산시',
          '부산',
          '해운대구',
        ...
        if (BUSAN_BELT_KEYWORDS.some((kw) => compact.startsWith(kw))) {
          return '부산권'
        }
